...
class MainPortal(http.Controller):
    ...
    def get_childs(self, page=0, search='', **kw):
        ...
        return request.render("fmp_custom_portal.adress", values)
    ...
    def add_adress(self, **kw):
        ...
        return request.render("fmp_custom_portal.add_adress", render_values)
    ...
    def edit_adress(self, **kw):
        ...
        render_values = {
            ...
            'countries': countries,
            'mode': kw['mode'] if 'mode' in kw else ''}
        return request.render("fmp_custom_portal.edit_adress", render_values)
