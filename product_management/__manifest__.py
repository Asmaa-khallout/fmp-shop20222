# -*- coding: utf-8 -*-
{
    ...
    "assets": {
        "web.assets_backend": [
                "product_management/static/src/js/product_kanbancontroller.js",
                "product_management/static/src/js/product_kanbanmodel.js",
                "product_management/static/src/js/product_kanbanrecord.js",
                "product_management/static/src/js/product_kanbanrender.js",
                "product_management/static/src/js/product_kanbanview.js",
                "product_management/static/src/css/styles.css"
        ],
        "web.assets_qweb": [
                "product_management/static/src/xml/*.xml"
        ]
},
    "demo": [
