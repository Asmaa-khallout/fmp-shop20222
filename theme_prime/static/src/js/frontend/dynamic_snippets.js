...
const { OwlMixin, MarkupRecords, ProductsBlockMixins, CategoryPublicWidgetMixins, ProductCarouselMixins, HotspotMixns, cartMixin} = require('theme_prime.mixins');
...
publicWidget.registry.s_d_products_snippet = ProductRootWidget.extend(OwlMixin, ProductsBlockMixins, {
    ...
    fieldstoFetch: ['name', 'price','qty_available', 'dr_label_id', 'rating', 'public_categ_ids', 'product_variant_ids'],
